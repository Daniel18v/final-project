    ...
    (function($) {
        $.fn.JSNESUI = function(roms) {
            ...
            var UI = function(nes) {
                ...
                self.romSelect = $('<button class="btn btn-primary bouton-image monBouton"></button>').appendTo(self.romContainer)

                self.controls = $('<div class="nes-controls"></div>').appendTo(self.root);
                self.buttons = {
                    pause: $('<input type="button" value="pause" class="nes-pause">').appendTo(self.controls),
