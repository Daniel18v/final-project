...
namespace Galaga {
    ...
    byte DSWAPort::Read()
    {
        ...
        val |= (galaga.cabinetType == GalagaMachine::CabinetType::Upright ? 0x80 : 0x00);
    ...
    byte DSWBPort::Read()
    {
        ...
        //PORT_DIPSETTING(    0x20, "20K, 60K, Every 60K" )   PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
        ...
        //PORT_DIPSETTING(    0x20, "30K, 100K, Every 100K" ) PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
